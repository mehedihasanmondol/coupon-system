...
@section('title', 'নতুন টেমপ্লেট তৈরি করুন')

@section('content')
<div class="d-flex justify-content-between align-items-center mb-3">
    <h2>নতুন টেমপ্লেট তৈরি করুন</h2>
        ...
        <form action="{{ route('admin.templates.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="mb-3">
                        <label for="template_image" class="form-label">টেমপ্লেট ছবি <span class="text-danger">*</span></label>
                        <input type="file" class="form-control @error('template_image') is-invalid @enderror" 
                               id="template_image" name="template_image" accept="image/*" required>
                        <small class="text-muted">সর্বোচ্চ সাইজ: 5MB (JPG, PNG)</small>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('qr_url_pattern') is-invalid @enderror" 
                               ...
                               value="{{ old('qr_url_pattern', 'https://example.com/coupon?code={coupon_code}') }}" required>
                ...
                <div class="col-md-6">
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control @error('qr_x_position') is-invalid @enderror" 
                                       id="qr_x_position" name="qr_x_position" value="{{ old('qr_x_position', 0) }}" required>
                                @error('qr_x_position')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control @error('qr_y_position') is-invalid @enderror" 
                                       id="qr_y_position" name="qr_y_position" value="{{ old('qr_y_position', 0) }}" required>
                                @error('qr_y_position')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control @error('qr_size') is-invalid @enderror" 
                                       id="qr_size" name="qr_size" value="{{ old('qr_size', 150) }}" required>
                                @error('qr_size')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control @error('coupon_number_x_position') is-invalid @enderror" 
                                       ...
                                       value="{{ old('coupon_number_x_position', 0) }}" required>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control @error('coupon_number_y_position') is-invalid @enderror" 
                                       ...
                                       value="{{ old('coupon_number_y_position', 0) }}" required>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control @error('coupon_number_font_size') is-invalid @enderror" 
                                       ...
                                       value="{{ old('coupon_number_font_size', 24) }}" required>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="color" class="form-control @error('coupon_number_font_color') is-invalid @enderror" 
                                       ...
                                       value="{{ old('coupon_number_font_color', '#000000') }}" required>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('coupon_number_font_path') is-invalid @enderror" 
                               ...
                               value="{{ old('coupon_number_font_path') }}" 
